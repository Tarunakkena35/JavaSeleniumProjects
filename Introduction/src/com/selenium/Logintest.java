...
public class Logintest {
	...
	public static void main(String[] args) throws InterruptedException {
		 ...
		 * Step 3: Logging-out the account 
		 * Step 4: Login with recently created account Credentials
		 * Step 5: Deleting the same account
		 * */
		
		//Creating the new account
		driver.findElement(By.cssSelector("ul.nav li a[href*='login']")).click();
		driver.findElement(By.xpath("//div[@class='signup-form']//input[@name='name']")).sendKeys("DammyJohn");
		driver.findElement(By.xpath("//div[@class='signup-form']//input[@name='email']")).sendKeys("Dammy2028@gmail.com");
		...
		//Login with recently created account Credentials
		driver.findElement(By.cssSelector("ul.nav li a[href*='login']")).click();  
		driver.findElement(By.xpath("//form[@action='/login']//input[@name='email']")).sendKeys("Dammy2028@gmail.com");
